...
datalogger = pd.read_csv(r'C:\git\data\PV_HeatPump_HEATING\20190301_TempControl_HEATING_SP18_Datalogger.csv',
                         encoding='unicode_escape')
# chiller
data_t_high = datalogger['T_ext']
data_t_low = datalogger['T_int']
...
dataseries.to_csv(r'C:\git\data\PV_HeatPump_HEATING\calc_cop_Tint_IN\COP_03.csv', decimal='.')
