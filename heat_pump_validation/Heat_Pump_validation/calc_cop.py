...
datalogger_1= pd.read_csv(r'file:///C:\git\data\PV_HeatPump_HEATING\20190304\20190304_temp_diff_data.csv',
                          parse_dates=True, index_col=0)
data_resample_1 = datalogger_1.resample('H').mean()
datalogger_2 = pd.read_csv(r'file:///C:\git\data\PV_HeatPump_HEATING\20190301\20190301_temp_diff_data.csv',
                           parse_dates=True, index_col=0)
...
dataseries.to_csv(r'C:\git\data\PV_HeatPump_HEATING\01_04_032019\resampled\COP_4.csv', decimal='.')
